...
intervals = [
    ...
    # basic simbols :;<=>&@
    # (58, 64),
    # latin upper case (64, 95)
    # (65, 90),
    # latin lower case (96, 126)
    # (97, 122),
    # basic latin
    (32, 126),
    # Latin Suppliment simbols °± (176, 190)
    (176, 177),
    # Cyrillic (0x0400=1024, 0x045F=1119) (1024 - 1105)
    (1024, 1105),
    # punctuation
    # (0x2010, 0x205F),
    # arrows
...
for i, g in enumerate(glyph_props):
    print ("    { " + ", ".join([f"{a}" for a in list(g[:-1])]),"},", f"// {g.code_point if g.code_point != 92 else '<backslash>'}")
print ("};");
